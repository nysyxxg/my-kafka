...
public class SimpleKafkaETLJob {
    ...
    protected JobConf createJobConf() throws Exception {
        ...
        jobConf.setMapperClass(SimpleKafkaETLMapper.class);//设置mapper
        KafkaETLInputFormat.setInputPaths(jobConf, new Path(_input));// 设置输入路径
        ...
        jobConf.setNumReduceTasks(0);// 没有reduce
        return jobConf;
    }
