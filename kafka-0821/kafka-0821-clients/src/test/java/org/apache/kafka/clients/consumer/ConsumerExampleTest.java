...
//        props.put("metadata.broker.list", "localhost1:9093,localhost2:9094,localhost3:9095");
        props.put("bootstrap.servers", "localhost1:9093,localhost2:9094,localhost3:9095");
...
//        props.put("value.serializer", "org.apache.kafka.common.serialization.StringSerializer");
         ...
         * 它会将partition循环的分配到consumer线程上。如果所有consumer实例的订阅都是确定的，
         * 则partitions的划分是确定的分布。循环分配策略只有在以下条件满足时才可以：
        ...
        while(isRunning) {
            Map<String, ConsumerRecords> records = consumer.poll(9);
            if(records!= null && records.size()>0){
                System.out.println("..........map  size........" + records.size());
                process(records);
            }
