...
object Message {
   ...
   */
  val CrcOffset = 0 // CRC验证码
  val CrcLength = 4
  val MagicOffset = CrcOffset + CrcLength // Magic字段
  val MagicLength = 1
  val AttributesOffset = MagicOffset + MagicLength //Attribute 字段
  val AttributesLength = 1
  val KeySizeOffset = AttributesOffset + AttributesLength // key长度字段
  val KeySizeLength = 4
  val KeyOffset = KeySizeOffset + KeySizeLength // key值
